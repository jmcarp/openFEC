...
from webservices.resources.candidates import CandidateList, CandidateView, CandidateYearView
...
api.add_resource(CandidateYearView, '/candidate/<string:candidate_id>/years')
